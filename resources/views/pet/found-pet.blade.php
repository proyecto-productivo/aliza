    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading barra">Registre la mascota que encontró</div>
                ...
                <div class="panel-body">
                    {!!Form::open(['route'=>'pet.store','method'=>'POST', 'files' => true])!!}
                        ...
                        <div class="form-group">
                            {!!form::label('Nombre de la mascota (si tiene placa)')!!}
                            {!!form::text('name',null,['id'=>'name','class'=>'form-control','placeholder'=>'Nombre de la mascota'])!!}
                        </div>

                        <div class="form-group">
                            {!!form::label('Color')!!}
                            {!!form::text('colors',null,['id'=>'colors','class'=>'form-control','placeholder'=>'Colores de la mascota'])!!}
                        </div>
                        ...
                        <div class="form-group">
                            {!!form::label('¿Lugar o barrio donde la encontró?')!!}
