    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading barra">¿Registra el documento que encontraste?</div>
                ...
                <div class="panel-body">
                    {!!Form::open(['route'=>'document.store','method'=>'POST'])!!}
                        ...
                        <div class="form-group">
                            ...
                            {!!form::text('name',null,['id'=>'name','class'=>'form-control','placeholder'=>'Nombre que aparece en documento'])!!}
                        </div>
                        ...
                        <div class="form-group">
                            {!!form::label('Ciudad donde lo encontró')!!}
