...
Route::get('/found-document', 'MainController@found_document')->name('found-document')->middleware('auth');
Route::get('/search-document', 'MainController@search_document')->name('search-document')->middleware('auth');
